    ...
    <header className="bg-[#4B6B70] text-white font-semibold tracking-wide">
      <div className="container flex items-center justify-between py-4 relative">
        ...
        <nav className="hidden md:flex items-center space-x-6">
          <Link href="/" className="hover:text-[#84AAAF] transition">Home</Link>
          ...
          >
            <Link href="/store" className="hover:text-[#84AAAF] transition">Store</Link>
            {isDropdownOpen && (
          ...
          <Link href="/join" className="hover:text-[#84AAAF] transition">Join</Link>
          <Link href="/blog" className="hover:text-[#84AAAF] transition">Blog</Link>
          <Link href="/testimonials" className="hover:text-[#84AAAF] transition">Testimonials</Link>
        </nav>
        ...
        {isMenuOpen && (
          <div className="fixed inset-0 bg-[#19333F] bg-opacity-95 text-white flex flex-col items-center justify-center z-[100]">
            ...
            <ul className="text-lg space-y-6">
              ...
              <li><Link href="/store" onClick={() => setIsMenuOpen(false)}>Store</Link></li>
              <li><Link href="/join" onClick={() => setIsMenuOpen(false)}>Join</Link></li>
