      ...
      >
        ...
        <div className="flex-1 min-h-0 overflow-hidden bg-[#FFF3DF] px-6 py-6">
          <div className="flex flex-wrap items-start justify-between gap-3 mb-0">
            ...
            <button type="button" className="bg-[#524b44] hover:bg-[#48423c] text-[#FFF3DF] font-blurlight py-2.5 px-8 rounded-sm transition-colors text-sm shrink-0 ml-auto" onClick={() => alert('Contact us for purchase information')}>Inquire now</button>
          </div>
