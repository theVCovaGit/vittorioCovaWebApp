...
export default function Footer() {
  ...
  return (
    <footer className={`fixed bottom-0 left-0 w-full font-blurlight z-50 pointer-events-auto px-4 sm:px-6 md:px-[4vw] pt-12 sm:pt-16 md:pt-20 pb-4 sm:pb-5 md:pb-6 ${((isArchitecturePage || isArtPage) && isExpandedViewOpen) ? 'bg-transparent' : isMainPage ? 'bg-[#302120]' : isFooterPage ? 'bg-[#302120]' : 'bg-[#5c4b4a]'}`}>
      <div className="absolute bottom-4 right-6 flex flex-col items-center space-y-2">
        <div className="flex flex-col items-center">
          ...
          <svg
            ...
            width="400"
            fill="none"
            className="w-full max-w-[160vw] sm:max-w-[800px] md:max-w-[1200px] h-auto"
            >
            {/* PLACEHOLDER: Insert your SVG path here */}
