...
import { useContactContent } from "@/hooks/usePageContent";
...
export default function ContactMobile() {
  ...
  return (
    <div className="relative h-screen overflow-hidden bg-[#fff3df] text-[#a08e80] font-blurlight px-3 py-4 pb-20 pt-20">
      ...
      {/* Hand - right above the "t" of CONTACT; iPad Mini: .ipad-mini-icon-gap + higher/bigger via .ipad-mini-icon-contact */}
      <div
      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center z-[1001] px-4">
        ...
        <div className="mb-4">
          <div className="flex items-center justify-center gap-2 mb-3">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" className="text-[#a08e80]">
            ...
            <span className="text-[0.65rem] font-blurlight">{content.instagram}</span>
          </div>
          ...
          <div className="flex items-center justify-center gap-2 mb-0">
            ...
            <span className="text-[0.65rem] font-blurlight">{content.email}</span>
          </div>
        </div>
        ...
        {/* Locations */}
        <div className="mb-4 text-[0.65rem] font-blurlight">
          <div>
