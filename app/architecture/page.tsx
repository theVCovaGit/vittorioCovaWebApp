        ...
        <div className="relative w-full h-full flex items-center">
          <div className="relative flex-shrink-0">
            ...
            <img 
              ...
              alt="Tape" 
              className="absolute -top-12 left-[5%] w-48 h-16 opacity-80 transform rotate-[2deg] z-50"
            />
            <img 
              src="/assets/tape2.svg" 
              alt="Tape" 
              className="absolute -top-12 left-[25%] w-48 h-16 opacity-80 transform rotate-[-5deg] z-50"
            />
            <img 
              src="/assets/tape3.svg" 
              alt="Tape" 
              className="absolute -top-12 left-[45%] w-48 h-16 opacity-80 transform rotate-[4deg] z-50"
            />
            <img 
              src="/assets/tape4.svg" 
              alt="Tape" 
              className="absolute -top-12 left-[65%] w-48 h-16 opacity-80 transform rotate-[-2deg] z-50"
            />
            <img 
              src="/assets/tape5.svg" 
              alt="Tape" 
              className="absolute -top-12 left-[85%] w-48 h-16 opacity-80 transform rotate-[3deg] z-50"
            />
            <img 
              src="/assets/tape6.svg" 
              alt="Tape" 
              className="absolute -top-12 left-[15%] w-48 h-16 opacity-80 transform rotate-[-4deg] z-50"
            />
          </div>
