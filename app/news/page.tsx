...
export default function News() {
  ...
  return (
    ...
    <main className="relative min-h-screen bg-[#fff3df] text-[#a08e80] font-blurlight overflow-hidden">
      ...
      >
        <div
          /* pb gives the last milestone room to clear the bottom edge when scrolled */
          className="flex flex-col items-center space-y-5 max-w-xs px-4 pb-40 overflow-y-auto min-h-0 w-full"
          style={{
