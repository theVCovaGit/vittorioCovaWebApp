...
const AdminPage = () => {
    ...
    return (
      <div className="flex items-center justify-center h-screen">
        <div className="w-96 p-6 bg-transparent text-white">
          <h1 className="text-2xl font-microextend mb-4 text-center"></h1>
          <input
            type="password"
            value={password}
  ...
  return (
    <div className="min-h-screen bg-[#5c4b4a] text-[#19333F] px-6 md:px-12 lg:px-24 mt-[10rem] sm:mt-[12rem] md:mt-[14rem] pb-28 sm:pb-32">
      <h1 className="font-microextend text-black text-2xl font-bold">Welcome back Vittorio</h1>
      
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-4">
        <button
          onClick={() => setActivePanel("architecture")}
          className="font-microextend bg-[#5c4b4a] border-2 border-black text-black py-3 px-6 rounded-md flex items-center gap-2"
        >
