...
export default function Contact() {
  return (
    <main className="relative min-h-screen bg-[#302120] text-[#fef4dc] font-basica overflow-hidden">
      ...
      <div className="absolute top-[8rem] left-1/2 transform -translate-x-1/2 text-[#fef4dc] font-electrolize text-center">
      ...
      {/* Locations - Lower Center */}
      <div className="absolute top-[65%] left-1/2 transform -translate-x-1/2 text-[#fef4dc] font-electrolize text-center">
      ...
      <div className="absolute bottom-[4rem] left-1/2 transform -translate-x-1/2 text-[#fef4dc] font-electrolize text-center">
