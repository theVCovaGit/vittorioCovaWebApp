...
export default function Contact() {
  ...
  return (
    <main className="relative min-h-screen bg-[#fff3df] text-[#a08e80] font-blurlight overflow-hidden">
      ...
      <div className="absolute top-[12rem] left-[20rem] text-[#a08e80] font-blurlight">
        <div className="flex items-center gap-3 mb-4">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" className="text-[#a08e80]">
      ...
      {/* Locations - Left */}
      <div className="absolute top-[70%] left-[20rem] text-[#a08e80] font-blurlight">
      ...
      {/* Copyright - Left */}
      <div className="absolute top-[78%] left-[24rem] text-[#a08e80] font-blurlight">
